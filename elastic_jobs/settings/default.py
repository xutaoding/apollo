...
# (u'key:', 'worker_log_format')
# (u'key:', 'worker_task_log_format')
# (u'key:', 'worker_log_color')
# (u'key:', 'task_queues')
# (u'key:', 'task_create_missing_queues')
# (u'key:', 'task_queue_ha_policy')
# (u'key:', 'task_queue_max_priority')
# (u'key:', 'task_default_queue')
# (u'key:', 'task_default_queue')
# (u'key:', 'task_default_exchange_type')
# (u'key:', 'worker_direct')
# (u'key:', 'include')
# (u'key:', 'broker_user')
# (u'key:', 'broker_password')
# (u'key:', 'broker_vhost')
# (u'key:', 'broker_port')
# (u'key:', 'broker_transport')
# (u'key:', 'broker_login_method')
# (u'key:', 'broker_failover_strategy')
# (u'key:', 'broker_transport_options')
# (u'key:', 'worker_hijack_root_logger')
# (u'key:', 'accept_content')
# (u'key:', 'worker_pool')
# (u'key:', 'broker_user')
# (u'key:', 'broker_password')
# (u'key:', 'broker_vhost')
...
# (u'key:', 'broker_failover_strategy')
# (u'key:', 'broker_transport_options')
# (u'key:', 'broker_heartbeat_checkrate')
# (u'key:', 'broker_heartbeat')
# (u'key:', 'worker_agent')
# (u'key:', 'broker_user')
# (u'key:', 'broker_password')
# (u'key:', 'broker_vhost')
...
# (u'key:', 'broker_failover_strategy')
# (u'key:', 'broker_transport_options')
# (u'key:', 'control_queue_ttl')
# (u'key:', 'control_queue_ttl')
# (u'key:', 'control_queue_expires')
# (u'key:', 'control_queue_expires')
# (u'key:', 'broker_user')
# (u'key:', 'broker_password')
# (u'key:', 'broker_vhost')
...
# (u'key:', 'broker_failover_strategy')
# (u'key:', 'broker_transport_options')
# (u'key:', 'worker_enable_remote_control')
# (u'key:', 'broker_user')
# (u'key:', 'broker_password')
# (u'key:', 'broker_vhost')
# (u'key:', 'broker_port')
...
# (u'key:', 'broker_failover_strategy')
# (u'key:', 'broker_transport_options')
# (u'key:', 'result_backend')
# (u'key:', 'result_serializer')
# (u'key:', 'result_cache_max')
# (u'key:', 'result_expires')
# (u'key:', 'accept_content')